  ...
  <div class="login-container animated-background">
    ...
    >
      ...
      <div class="glass-content">
        ...
        <form :model="form" :rules="rules" ref="formRef" class="login-form">
          <div class="form-group">
            <input type="text" v-model.trim="form.username" placeholder="用户名" class="glass-input">
          </div>
          <div class="form-group">
            <input type="password" v-model.trim="form.password" placeholder="密码" class="glass-input">
          </div>
          <button type="submit" @click="onSubmit" class="glass-button">登录</button>
...
.animated-background {
  width: 100%;
  height: 100%;
  background-image: url('../../vue-app/src/assets/image/login.png');
